...
CROSSES = [
    # ref_url None below: prior hotlink was dead (404 bigcommerce) -> gallery falls back to search link
    ("C_Hardyana", "C. Hardyana", {"dowiana": 50, "warscewiczii": 50}, None),
    # ref_url None: prior hotlink hotlink-blocked (403 orchids.org) -> search-link fallback
    ("C_Brabantiae", "C. Brabantiae", {"aclandiae": 50, "loddigesii": 50}, None),
    # ref_url None: orchidroots /static path was an SPA soft-404 (text/html) -> search-link fallback
    (
        "C_Interglossa",
        "C. Interglossa",
        {"amethystoglossa": 50, "intermedia": 50},
        None,
    ),
    (
        "C_Empress_Frederick",
        "C. Empress Frederick",
        {"dowiana_aurea": 50, "mossiae": 50},
        None,
    ),
    (
        "C_guatemalensis",
        "C. guatemalensis",
        {"aurantiaca": 50, "skinneri": 50},
        "https://s3.amazonaws.com/iof-grexes3/177619.jpg",
    ),
    (
        "C_Canhamiana",
        "C. Canhamiana",
        {"purpurata": 50, "mossiae": 50},
    ...
    (
        "C_Pittiae",
        "C. Pittiae",
        {"harrisoniana": 50, "schilleriana": 50},
        None,
    ),
    (
        "C_Leda",
        "C. Leda",
        {"dowiana": 50, "percivaliana": 50},
    ...
    (
        "C_Landate",
        "C. Landate",
        {"aclandiae": 50, "guttata": 50},
        None,
    ),
    (
        "C_Wendlandiana",
        "C. Wendlandiana",
        {"bowringiana": 50, "warscewiczii": 50},
        None,
    ),
    # ref_url None: prior hotlink was dead (404 bigcommerce) -> search-link fallback
    (
        "C_Dupreana",
        "C. Dupreana",
        {"warneri": 50, "warscewiczii": 50},
        None,
    ),
    (
        "C_Dolosa",
        "C. Dolosa",
        {"loddigesii": 50, "walkeriana": 50},
    ...
    (
        "C_Venus",
        "C. Venus",
        {"dowiana": 75, "bicolor": 25},
        None,
    ),  # complex: dowiana × Iris(1901)
    (
        "C_Whitei",
        "C. Whitei",
        {"schilleriana": 50, "warneri": 50},
        "https://s3.amazonaws.com/iof-grexes3/131022.jpg",
    ),
    (
        "C_Measuresiana",
        "C. Measuresiana",
        {"aclandiae": 50, "walkeriana": 50},
        "https://www.krullsmith.com/images/product/large/385_1_.jpg",
    ),
    (
        "C_Elegans",
        "C. Elegans",
        {"tigrina": 50, "purpurata": 50},
        "https://s3.amazonaws.com/iof-grexes3/133806.jpg",
    ),
    (
        "C_Peetersii",
        "C. Peetersii",
        {"lawrenceana": 50, "warscewiczii": 25, "purpurata": 25},
        "https://s3.amazonaws.com/iof-grexes3/56219.jpg",
    ),  # complex: Callistoglossa × lawrenceana
    ("C_Minucia", "C. Minucia", {"loddigesii": 50, "warscewiczii": 50}, None),
    (
        "C_Brymeriana",
        "C. Brymeriana",
        {"violacea": 50, "wallisii": 50},
        "https://s3.amazonaws.com/iof-grexes3/52093.jpg",
    ),  # natural hybrid
    # ref_url None: prior hotlink was dead (404 bigcommerce) -> search-link fallback
    (
        "C_Portia",
        "C. Portia",
        {"bowringiana": 50, "labiata": 50},
        None,
    ),
    (
        "C_Mem_Albert_Heinecke",
        "C. Mem. Albert Heinecke",
        {"dowiana": 69, "bicolor": 16, "tenebrosa": 13, "warscewiczii": 3},
        "https://s3.amazonaws.com/iof-grexes3/56357.jpg",
    ),  # complex hybrid
]

# Convenience accessors
CROSSES_SIMPLE = [(name, ancestry) for name, _, ancestry, _ in CROSSES]
CROSSES_WITH_DISPLAY = [
    (name, display, ancestry) for name, display, ancestry, _ in CROSSES
]
